<?php
	...
	class Log extends CakeTestModel {
		...
		public $order = 'id DESC'; // assume created with cake core is used and works
	...
	class LogableUser extends CakeTestModel {
		...
		public $actsAs = array('Logable' => array('userModel' => 'LogableUser', 'ignore' => array('counter')));
	}
	...
	class LogableCase extends AppBehaviorTestCase {
		public $BookTest = NULL;

		public $Log = NULL;

		public $setup = array(
			'behavior' => 'History.Logable',
			'fixtures' => array(
				'do' => array(
					'History.Log',
					'History.LogableBook',
					'History.LogableComment',
					'History.LogableLog',
					'History.LogableUser'
				)
			)
