<?php
	...
	class DraftedCase extends AppBehaviorTestCase {
		public $setup = array(
			'behavior' => 'History.Drafted',
			'fixtures' => array(
				'do' => array(
					'History.DraftedPost',
					'History.DraftedPostsDraft'
				)
			)
		);
		...
		public function testFindAllWithDrafts() {
			$Post = ClassRegistry::init('DraftedPost', 'model');
			$this->loadFixtures('DraftedPost', 'DraftedPostsDraft');
		...
		public function testfindDraftsCheck() {
			$Post = ClassRegistry::init('DraftedPost', 'model');
			$this->loadFixtures('DraftedPost', 'DraftedPostsDraft');
		...
		public function testSaveDirect() {
			$Post = ClassRegistry::init('DraftedPost', 'model');
		...
		public function testSaveEditDirect() {
			$Post = ClassRegistry::init('DraftedPost', 'model');
			$this->loadFixtures('DraftedPost');
		...
		public function testModerartionAcceptOnEdit() {
			$Post = ClassRegistry::init('DraftedPost', 'model');
			$this->loadFixtures('DraftedPost');
		...
		public function testModerationAcceptOnCreate() {
			$Post = ClassRegistry::init('DraftedPost', 'model');
			$this->loadFixtures('DraftedPost');
